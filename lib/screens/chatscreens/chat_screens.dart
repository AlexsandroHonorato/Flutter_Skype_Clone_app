                ...
                Flexible(
                  child: ListView(
                    children: <Widget>[
                      ...
                      ModalTile(
                        title: "Media",
                        subtitle: "Compartilhe fotos e vídeos",
                        icon: Icons.image,
                        onTap: () => pickImage(source: ImageSource.gallery),
                      ),
                      ModalTile(
                          title: "Arquivo",
                          subtitle: "Compartilhar arquivos",
                          icon: Icons.tab),
                      ModalTile(
                          title: "Contato",
                          subtitle: "Compartilhar contatos",
                          icon: Icons.contacts),
                      ModalTile(
                          title: "Localização",
                          subtitle: "Compartilhe um local",
                          icon: Icons.add_location),
                      ModalTile(
                          title: "Agendar ligação",
                          subtitle:
                              "Organize uma chamada pelo skype e receba lembretes",
                          icon: Icons.schedule),
                      ModalTile(
                          title: "Criar Enquete",
                          subtitle: "Compartilhar enquetes",
                          icon: Icons.poll)
                    ],
                  ),
                ),
    ...
    return CustomAppBar(
      ...
      actions: <Widget>[
        IconButton(
          ...
          onPressed: () async => await Permission.microphone.isGranted
              ? CallUtils.dial(
